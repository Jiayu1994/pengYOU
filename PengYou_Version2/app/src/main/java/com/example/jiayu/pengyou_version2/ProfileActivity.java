...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNotificationDatabase = FirebaseDatabase.getInstance().getReference().child("notifications"); // Part 21
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfileActivity.this).load(image).placeholder(R.drawable.domo_default_picture).into(mProfileImage);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.hasChild(user_id)) {
                            ...
                            if (req_type.equals("received")) {
                                ...
                                //Part 21 Firebase Notifications
